  ...
  for line in lines:
    ...
    if match := insert_pattern.match(line):
      ...
      if id not in active_inserts:
        return False, id#f"Stopping a non-existent or already stopped insert."
...
file_names = ['C:/Users/Dell G3/OneDrive/Desktop/Data Struct/final_project_update_1219/final_project_update_1219/Problem1_test_case.txt', 'C:/Users/Dell G3/OneDrive/Desktop/Data Struct/final_project_update_1219/final_project_update_1219/Problem2_test_case.txt']
